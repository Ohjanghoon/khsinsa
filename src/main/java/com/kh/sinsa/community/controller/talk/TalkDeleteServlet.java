...
/**
 * Servlet implementation class TalkDeleteServlet
 */
@WebServlet("/community/talkDelete")
public class TalkDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			// 2. 업무로직
			int result = communityService.deleteTalk(no);
