...
/**
 * Servlet implementation class TalkListServlet
 */
@WebServlet("/community/talkList")
public class TalkListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			try {
				...
				// 2. 업무로직
				List<Community> list = communityService.findTalkAll(param);
				...
				request.getRequestDispatcher("/WEB-INF/views/talk/talkList.jsp")
