...
/**
 * Servlet implementation class ProductBottomFindServlet
 */
@WebServlet("/product/productBottomFindServlet")
public class ProductBottomFindServlet extends HttpServlet {
