...
<div class="container">
	...
	<div class="main">
	<h2 style="font-size: 40px; color: purple; font-weight:bold;">자유게시판 <span style="font-size: 18px;">You are free here</span>
	</h2>
	<hr style="border-top: 3px solid purple;">
		...
		<ul>
			...
			%> <img src ="<%= request.getContextPath() %>/upload/free/<%= attach.getRenamedFilename() %>" class="upload">
				<%}
					}  %>
