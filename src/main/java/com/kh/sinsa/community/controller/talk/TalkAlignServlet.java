...
/**
 * Servlet implementation class TalkAlignServlet
 */
@WebServlet("/community/talkAlign")
public class TalkAlignServlet extends HttpServlet {
...
try {
			...
			// 업무로직
			List<Community> list = communityService.talkAlign(param);
			int totalContent = communityService.getTalkTotalContent();
